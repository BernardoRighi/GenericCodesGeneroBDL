...
#+
function compare_arrays_and_records(first_array om.DomNode, second_array om.DomNode, compares_size boolean, compares_structure boolean, compares_values boolean)
